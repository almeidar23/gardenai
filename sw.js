...
const CACHE_NAME = 'gardenai-v117';
const ASSETS = [
  './',
  './index.html',
  './css/styles.css',
...
// Activate — clean old caches, then tell every open tab to reload
// so ES module instances are replaced with the newly cached versions.
